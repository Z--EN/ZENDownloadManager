...
open class ZENUtility: NSObject {
    
    open static let DownloadCompletedNotif: String = {
        return "com.ZENDownloadManager.DownloadCompletedNotif"
    }()
    ...
    open static let tmpFilePath: String = {
        return (NSHomeDirectory() as NSString).appendingPathComponent("tmp") as String
    }()
